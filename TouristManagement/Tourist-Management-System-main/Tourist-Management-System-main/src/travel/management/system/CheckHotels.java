...
public class CheckHotels extends JFrame implements Runnable {
    ...
    JLabel caption;
    public void run(){
        String[] text=new String[]{"JW Marriot Hotel","Madarin Oriental Hotel","Four Seasons Hotel","Raddisson Blue Hotel","Classio Hotel","The Bay Club Hotel","Breeze Blow Hotel","The Taj Hotel","Happy Morning Hotel","River View Hotel"};
        try{
            for(int i=0;i<=9;i++){
