...
public class ViewPackage extends JFrame implements ActionListener{
    JLabel lblusername,lblid,lblnumber,lblphonenumber,text,lblpackage,lblpersons,lblprice;
    JLabel labelusername,labelid,labelnumber,labelphonenumber,labelpackage,labelpersons,labelprice ;
    JButton back;
