...
public class Signup extends JFrame implements ActionListener {
    ...
    Signup(){
       setBounds(350,200,900,360);
        ...
        JLabel lblusrename = new JLabel("Username");
        lblusrename.setBounds(50,20,125,25);
        lblusrename.setFont(new Font("Tahoma",Font.BOLD,14));
        p1.add(lblusrename);
        ...
        security = new Choice();
        security.add("BestFriend from the school");
